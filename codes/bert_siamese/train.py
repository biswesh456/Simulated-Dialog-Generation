...
parser.add_argument('--num-epochs', type=int, default=15, metavar='E', help='Number of epochs for training the model')
...
print("DATA LOADING......")
data = Data.SubData(data_dir = args.data_dir, vocab_size=args.vocab_size, bert_model_name=args.bert_model)
